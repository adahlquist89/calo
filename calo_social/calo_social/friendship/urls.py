...
urlpatterns = patterns('',
    ...
    url(
        regex=r'^friends/(?P<username>[\w-]+(\.)*(\w)*)/$',
        view=view_friends,
        name='friendship_view_friends',
    ),
    url(
        regex=r'^friend/add/(?P<to_username>[\w-]+(\.)*(\w)*)/$',
    ...
    url(
        regex=r'^followers/(?P<username>[\w-]+(\.)*(\w)*)/$',
        view=followers,
        name='friendship_followers',
    ),
    url(
        regex=r'^following/(?P<username>[\w-]+(\.)*(\w)*)/$',
        view=following,
        name='friendship_following',
    ),
    url(
        regex=r'^follower/add/(?P<followee_username>[\w-]+(\.)*(\w)*)/$',
        view=follower_add,
        name='follower_add',
    ),
    url(
        regex=r'^follower/remove/(?P<followee_username>[\w-]+(\.)*(\w)*)/$',
